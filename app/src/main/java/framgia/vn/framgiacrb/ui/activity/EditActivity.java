...
public class EditActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    public void addEventFormWidgets() {
        ...
        mTxtDateStart.setOnClickListener(myButtonEvent);
        mTxtTimeStart.setOnClickListener(myButtonEvent);
        mTxtDateFinish.setOnClickListener(myButtonEvent);
        mTxtTimeFinish.setOnClickListener(myButtonEvent);
    }
