...
import framgia.vn.framgiacrb.data.model.EventInWeek;
...
public class CreateEventActivity extends AppCompatActivity implements View.OnTouchListener,
    ...
    ArrayList<EventInWeek> arrJob = new ArrayList<>();
    ...
    private void initViews() {
        ...
        mSwitchAlarm.setOnClickListener(this);
        ...
        mTxtPlace.setOnClickListener(this);
        ...
        mTxtAttendee.setOnClickListener(this);
    ...
    public NewEvent createEvent() throws ParseException {
        ...
        event.setStartTime(TimeUtils.convertToTimeZoneZero(TimeUtils.formatDateTime(mDateStart,
            mTimeEventStart)));
        event
            .setFinishTime(TimeUtils.convertToTimeZoneZero(TimeUtils.formatDateTime(mDateFinish,
                mTimeEventFinish)));
