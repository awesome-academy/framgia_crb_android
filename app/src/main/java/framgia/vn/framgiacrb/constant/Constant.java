...
public class Constant {
    ...
    public static final int[] COLOR_PLACE =
        {R.color.color_place_1, R.color.color_place_2, R.color.color_place_3,
            R.color.color_place_4, R.color.color_place_5, R.color.color_place_6,
            R.color.color_place_7,
